...
def calc_pot_odds_from_game_state(
    game_state: Union[str, Dict[str, Any]],
    to_call_override: Optional[float] = None
) -> Dict[str, Any]:
    """
    ...
    to_call = float(to_call_override if to_call_override is not None else state.get("to_call", 0))
